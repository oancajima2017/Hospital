...
import entity.controlador.DocVentaFacade;
...
public class DocVentaController implements Serializable {
    ...
    @EJB
    private entity.controlador.DocVentaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vistas").getString("DocVentaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vistas").getString("DocVentaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vistas").getString("DocVentaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
